...
public class Fabrica {
   ...
   public static void main(String[] args){
      ...
      System.out.println("Número de portas do carro do Zé: ");
      int numeroPortas = Integer.parseInt(input.nextLine());
      System.out.println("Velocidade máxima do carro do Zé: ");
      int velocidadeMaxima = Integer.parseInt(input.nextLine());
      System.out.print("Nome do prorpietário do carro do Zé: ");
      String nomeProp = input.nextLine();
      System.out.println("Km rodados do carro do Zé: ");
      int kmRodados = Integer.parseInt(input.nextLine());
      System.out.println("Litros de combustível do carro do Zé: ");
      int litrosCombustivel = Integer.parseInt(input.nextLine());
      Carro carroDoZe = new Carro(cor, marca, modelo , numeroPortas, velocidadeMaxima, nomeProp, kmRodados, litrosCombustivel);
      System.out.println("---------------------------------------");
      ...
      carroDoZe.setModelo("Calhambeque");azul
      System.out.println("----------------------------");
      //recuperar variáveis:
      /*
